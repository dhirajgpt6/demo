package com.example.demo.stream.gitcode;

import com.example.demo.stream.gitcode.dto.Student;
...
//        System.out.println(uniqueList);
        ...
        Map<String, List<Student>> studentMap =
                students.stream().collect(Collectors.groupingBy(student -> student.getGrade() >= 70 ? "Pass" : "Fail"));
