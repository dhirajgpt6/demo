package com.example.demo.compratorcomparable.afterjava8;
...
public class ComparatorDemo {
    public static void main(String[] args) {
       ...
       Reverse Order Sorting
        ...
        fruits.sort(Comparator.comparingInt(String::length)); //More concise & modern
//        Collections.sort(fruits, Comparator.comparingInt(String::length)); //Old way using Collections.sort
